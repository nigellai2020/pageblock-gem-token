        ...
        render() {
            return (this.$render("i-panel", null,
                this.$render("i-panel", null,
                    ...
                    this.$render("i-grid-layout", { id: 'gridDApp', width: '100%', height: '100%', templateColumns: ['repeat(2, 1fr)'], gap: { column: '6.313rem' }, padding: { bottom: '1.563rem' } },
                        this.$render("i-vstack", { padding: { top: '0.5rem', bottom: '0.5rem', left: '5.25rem', right: '0.5rem' }, gap: "0.813rem" },
